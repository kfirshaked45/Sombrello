    ...
    <div className="board-header">
      ...
      <div className={`board-header-right-container ${fontColor === 'dark' ? 'dark' : 'light'}`}>
        ...
        <div className="members-img">
          <img src={'http://localhost:3000/static/media/kfirImg.529b8f065f81254bb43f.jpg'} alt="Member" />
          <img src={'http://localhost:3000/static/media/omer-img.adeaa4fddaaf9226ce5e.jpg'} alt="Member" />
          <img src={'http://localhost:3000/static/media/user-img1.c45c54ba2d7e0d54e22e.jpg'} alt="Member" />
        </div>
